        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('loans.store') }}" method="POST">
                    ...
                    <div class="form-group form-row">
                            <div class="col-md-4">
                                <label for="numero">{{__('Number of payments')}}</label>
                                <input type="text" name="numero_pagos" id="numero_pagos" class="form-control @error('numero_pagos') is-invalid @enderror">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="total" id="total" readonly="readonly" class="form-control @error('total') is-invalid @enderror">
                    ...
                    <div class="form-group form-row">
                            <div class="col-md-6">
                                ...
                                <input type="date" value="<?php echo date('Y-m-d'); ?>"  name="fecha_ministracion" id="fecha_ministracion" class="form-control @error('fecha_ministracion') is-invalid @enderror">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="fecha_vencimiento" id="fecha_vencimiento" readonly="readonly" value=" " class="form-control @error('fecha_vencimiento') is-invalid @enderror">
